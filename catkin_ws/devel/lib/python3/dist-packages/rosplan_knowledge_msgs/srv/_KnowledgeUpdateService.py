...
class KnowledgeUpdateServiceRequest(genpy.Message):
  _md5sum = "984125cae1f7618f37933a0ded6cd81a"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.knowledge.values:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_dB().pack(_x.knowledge.function_value, _x.knowledge.assign_op))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.knowledge.function_value, _x.knowledge.assign_op,) = _get_struct_dB().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
class KnowledgeUpdateService(object):
  ...
  _md5sum = 'd060e04949a9983be27b1c491c4edf7c'
