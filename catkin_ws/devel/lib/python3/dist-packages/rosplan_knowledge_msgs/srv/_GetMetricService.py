...
class GetMetricServiceResponse(genpy.Message):
  _md5sum = "2a717b6a70afe64acb5dfd82f017c6e7"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.metric.values:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_dB().pack(_x.metric.function_value, _x.metric.assign_op))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.metric.function_value, _x.metric.assign_op,) = _get_struct_dB().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
