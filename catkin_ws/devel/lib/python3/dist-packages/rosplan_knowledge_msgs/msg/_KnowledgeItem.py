...
class KnowledgeItem(genpy.Message):
  _md5sum = "eb1f72eba0c2c67ff10276f88d435a64"
...
"""
  ...
  __slots__ = ['knowledge_type','initial_time','is_negative','instance_type','instance_name','attribute_name','values','function_value','assign_op','optimization','expr','ineq']
  _slot_types = ['uint8','time','bool','string','string','string','diagnostic_msgs/KeyValue[]','float64','uint8','string','rosplan_knowledge_msgs/ExprComposite','rosplan_knowledge_msgs/DomainInequality']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       knowledge_type,initial_time,is_negative,instance_type,instance_name,attribute_name,values,function_value,assign_op,optimization,expr,ineq
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.values:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_dB().pack(_x.function_value, _x.assign_op))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.function_value, _x.assign_op,) = _get_struct_dB().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
