...
struct OverlayClouds_
{
  ...
  _min_pass_through_type min_pass_through;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _hit_counts_type;
  _hit_counts_type hit_counts;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _pass_through_counts_type;
