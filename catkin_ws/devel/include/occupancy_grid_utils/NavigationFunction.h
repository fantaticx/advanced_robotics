...
struct NavigationFunction_
{
  ...
  _valid_type valid;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _back_pointers_type;
  _back_pointers_type back_pointers;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _potential_type;
