...
struct GetDomainOperatorServiceResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _operators_type;
