...
struct DomainFormula_
{
  ...
  _name_type name;
   ...
   typedef std::vector< ::diagnostic_msgs::KeyValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::diagnostic_msgs::KeyValue_<ContainerAllocator> >> _typed_parameters_type;
