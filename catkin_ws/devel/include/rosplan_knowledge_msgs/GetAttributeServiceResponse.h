...
struct GetAttributeServiceResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> >> _attributes_type;
