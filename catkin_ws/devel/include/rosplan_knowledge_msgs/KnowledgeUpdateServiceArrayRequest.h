...
struct KnowledgeUpdateServiceArrayRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _update_type_type;
  _update_type_type update_type;

   typedef std::vector< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> >> _knowledge_type;
