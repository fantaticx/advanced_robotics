...
struct ExprComposite_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::rosplan_knowledge_msgs::ExprBase_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::ExprBase_<ContainerAllocator> >> _tokens_type;
  _tokens_type tokens;
