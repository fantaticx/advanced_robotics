...
struct DomainOperator_
{
  ...
  _formula_type formula;
   ...
   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_start_add_effects_type;
  _at_start_add_effects_type at_start_add_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_start_del_effects_type;
  _at_start_del_effects_type at_start_del_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_end_add_effects_type;
  _at_end_add_effects_type at_end_add_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_end_del_effects_type;
  _at_end_del_effects_type at_end_del_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainAssignment_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainAssignment_<ContainerAllocator> >> _at_start_assign_effects_type;
  _at_start_assign_effects_type at_start_assign_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainAssignment_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainAssignment_<ContainerAllocator> >> _at_end_assign_effects_type;
  _at_end_assign_effects_type at_end_assign_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::ProbabilisticEffect_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::ProbabilisticEffect_<ContainerAllocator> >> _probabilistic_effects_type;
  _probabilistic_effects_type probabilistic_effects;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_start_simple_condition_type;
  _at_start_simple_condition_type at_start_simple_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _over_all_simple_condition_type;
  _over_all_simple_condition_type over_all_simple_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_end_simple_condition_type;
  _at_end_simple_condition_type at_end_simple_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_start_neg_condition_type;
  _at_start_neg_condition_type at_start_neg_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _over_all_neg_condition_type;
  _over_all_neg_condition_type over_all_neg_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainFormula_<ContainerAllocator> >> _at_end_neg_condition_type;
  _at_end_neg_condition_type at_end_neg_condition;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> >> _at_start_comparison_type;
  _at_start_comparison_type at_start_comparison;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> >> _at_end_comparison_type;
  _at_end_comparison_type at_end_comparison;

   typedef std::vector< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::DomainInequality_<ContainerAllocator> >> _over_all_comparison_type;
