...
struct KnowledgeQueryServiceResponse_
{
  ...
  _all_true_type all_true;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _results_type;
  _results_type results;

   typedef std::vector< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_knowledge_msgs::KnowledgeItem_<ContainerAllocator> >> _false_knowledge_type;
