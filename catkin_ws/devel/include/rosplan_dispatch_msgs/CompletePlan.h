...
struct CompletePlan_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::rosplan_dispatch_msgs::ActionDispatch_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_dispatch_msgs::ActionDispatch_<ContainerAllocator> >> _plan_type;
  _plan_type plan;
