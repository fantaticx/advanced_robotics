...
struct EsterelPlanEdge_
{
  ...
  _edge_id_type edge_id;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _edge_name_type;
  _edge_name_type edge_name;

   typedef int32_t _signal_type_type;
  _signal_type_type signal_type;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _source_ids_type;
  _source_ids_type source_ids;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _sink_ids_type;
...
struct Printer< ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator>& v)
  {
    ...
    s << indent << "edge_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.edge_name);
