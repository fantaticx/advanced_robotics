...
struct EsterelPlan_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::rosplan_dispatch_msgs::EsterelPlanNode_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_dispatch_msgs::EsterelPlanNode_<ContainerAllocator> >> _nodes_type;
  _nodes_type nodes;

   typedef std::vector< ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator> >> _edges_type;
  _edges_type edges;
