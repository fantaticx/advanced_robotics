...
struct ActionFeedback_
{
  ...
  _status_type status;
   ...
   typedef std::vector< ::diagnostic_msgs::KeyValue_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::diagnostic_msgs::KeyValue_<ContainerAllocator> >> _information_type;
