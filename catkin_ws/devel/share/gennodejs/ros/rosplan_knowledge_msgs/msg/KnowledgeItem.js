...
class KnowledgeItem {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('assign_op')) {
        this.assign_op = initObj.assign_op
      }
      else {
        this.assign_op = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [assign_op]
    bufferOffset = _serializer.uint8(obj.assign_op, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [assign_op]
    data.assign_op = _deserializer.uint8(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.assign_op !== undefined) {
      resolved.assign_op = msg.assign_op;
    }
    else {
      resolved.assign_op = 0
    }
