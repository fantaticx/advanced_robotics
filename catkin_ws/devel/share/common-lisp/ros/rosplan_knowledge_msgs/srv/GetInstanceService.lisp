...
(cl:defclass <GetInstanceService-request> (roslisp-msg-protocol:ros-message)
  ((type_name
    ...
    :initform "")
   (include_constants
    :reader include_constants
    :initarg :include_constants
    :type cl:boolean
    :initform cl:nil)
   (include_subtypes
    :reader include_subtypes
    :initarg :include_subtypes
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:ensure-generic-function 'include_constants-val :lambda-list '(m))
(cl:defmethod include_constants-val ((m <GetInstanceService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_knowledge_msgs-srv:include_constants-val is deprecated.  Use rosplan_knowledge_msgs-srv:include_constants instead.")
  (include_constants m))

(cl:ensure-generic-function 'include_subtypes-val :lambda-list '(m))
(cl:defmethod include_subtypes-val ((m <GetInstanceService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_knowledge_msgs-srv:include_subtypes-val is deprecated.  Use rosplan_knowledge_msgs-srv:include_subtypes instead.")
  (include_subtypes m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetInstanceService-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'include_constants) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'include_subtypes) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetInstanceService-request>) istream)
  "Deserializes a message object of type '<GetInstanceService-request>"
    ...
    (cl:setf (cl:slot-value msg 'include_constants) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'include_subtypes) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetInstanceService-request>)))
  ...
  "72fcbb7309926c5129a3fae2ecc031b8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetInstanceService-request)))
  "Returns md5sum for a message object of type 'GetInstanceService-request"
  "72fcbb7309926c5129a3fae2ecc031b8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetInstanceService-request>)))
  ...
  (cl:format cl:nil "# PDDL problem generation; service(1/3):~%# Get all instances of the type with the name 'typeName'.~%string type_name~%bool include_constants~%bool include_subtypes~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetInstanceService-request)))
  "Returns full string definition for message of type 'GetInstanceService-request"
  (cl:format cl:nil "# PDDL problem generation; service(1/3):~%# Get all instances of the type with the name 'typeName'.~%string type_name~%bool include_constants~%bool include_subtypes~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <GetInstanceService-request>))
  ...
  (cl:list 'GetInstanceService-request
    ...
    (cl:cons ':include_constants (include_constants msg))
    (cl:cons ':include_subtypes (include_subtypes msg))
))
