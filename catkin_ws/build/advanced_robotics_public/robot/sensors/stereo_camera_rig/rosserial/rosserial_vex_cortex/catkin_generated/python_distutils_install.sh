...
echo_and_run cd "/home/thomas/Documents/university/ar/catkin_ws/src/advanced_robotics_public/robot/sensors/stereo_camera_rig/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/thomas/Documents/university/ar/catkin_ws/src/advanced_robotics_public/robot/sensors/stereo_camera_rig/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/thomas/Documents/university/ar/catkin_ws/build/advanced_robotics_public/robot/sensors/stereo_camera_rig/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
